...
a = Analysis(
    ...
    datas=[('src/ai_producer_hub', 'ai_producer_hub')],
...
_keep_dist = ['fastmcp-', 'mcp-', 'prefab_ui-']
...
pyz = PYZ(a.pure)
exe = EXE(pyz, a.scripts, a.binaries, a.zipfiles, a.datas, name='ai-producer-hub-backend', debug=False, strip=False, upx=False, upx_exclude=[], runtime_tmpdir=None, console=False)
