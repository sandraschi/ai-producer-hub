...
const BACKEND_NAME: &str = "ai-producer-hub-backend.exe";
const BACKEND_PORT: u16 = 11171;
const BACKEND_TAG: &str = "ai-producer-hub-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "MCP_PORT";
const ENV_HOST: &str = "MCP_HOST";
const ENV_TAURI: &str = "AI_PRODUCER_HUB_TAURI";
